                ...
                <>
                  <div className="row main">
                    <div className="progress">
                      {currentResults.length <= 5 && <PollProgress results={currentResults} />}
                      {currentResults.length > 5 && <PollRanking results={currentResults} />}
                    </div>
                  ...
                  <div className="row sub">
                    <div className="options">
                      {currentResults.length <= 5 && currentResults.map((result, index) => (
